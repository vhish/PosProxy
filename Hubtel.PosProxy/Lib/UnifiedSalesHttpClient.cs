...
{
    public sealed class UnifiedSalesHttpClientBase
    {
        private static volatile HttpClient instance;
        private static object syncRoot = new object();

        private UnifiedSalesHttpClientBase() { }
    ...
    public class UnifiedSalesHttpClient : IUnifiedSalesHttpClient
    {
        private HttpClient _httpClient;
        private readonly ILogger _logger;

        public UnifiedSalesHttpClient(ILogger<UnifiedSalesHttpClient> logger)
        {
            _httpClient = UnifiedSalesHttpClientBase.Instance;
            _logger = logger;
        }
    ...
    public interface IUnifiedSalesHttpClient
    {
